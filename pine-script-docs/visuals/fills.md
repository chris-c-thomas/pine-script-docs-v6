...
Some of Pine Script’s visual outputs, including [plots](/pine-script-docs/language/type-system/#plot-and-hline), [hlines](/pine-script-docs/language/type-system/#plot-and-hline), [lines](/pine-script-docs/visuals/lines-and-boxes/#lines), [boxes](/pine-script-docs/visuals/lines-and-boxes/#boxes), and [polylines](/pine-script-docs/visuals/lines-and-boxes/#polylines), allow one to fill the chart space they occupy with colors. Three different mechanisms facilitate filling the space between such outputs:
...
- Other drawing types, namely [boxes](/pine-script-docs/visuals/lines-and-boxes/#boxes) and [polylines](/pine-script-docs/visuals/lines-and-boxes/#polylines), have built-in properties that allow the drawings to fill the visual spaces they occupy.
...
See this manual’s [Lines and boxes](/pine-script-docs/visuals/lines-and-boxes/) page to learn more about working with these types.
