...
Some built-ins return information on the trading session the current bar belongs to. They are explained in the [Session states](/pine-script-docs/concepts/sessions/#session-variables-reference) section.
