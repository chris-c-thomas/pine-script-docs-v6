...
Note that other types of repainting such as those documented in our [Repainting](/pine-script-docs/concepts/repainting/) section may not be preventable by simply triggering alerts on the close of realtime bars.
