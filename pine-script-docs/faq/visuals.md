...
![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-Why-cant-i-use-a-plot-in-an-if-or-for-statement-1.3rjsIGWF_Z1AAQRi.webp)
...
- The script updates the Boolean variable that describes whether the moving averages are in bullish order — and thereby controls the plots and fill — in a _local scope_. However, the script declares it in the _global scope_ so that the [fill()](https://www.tradingview.com/pine-script-reference/v6/#fun_fill) and [plot()](https://www.tradingview.com/pine-script-reference/v6/#fun_plot) calls can use it.
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-Can-i-plot-diagonals-between-two-points-on-the-chart-1.Dcpal7Wj_1QXb2x.webp)
...
The following example script demonstrates these advantages. Like the example script in the previous section, [Using plots](/pine-script-docs/faq/visuals/#using-plots), this script draws lines between pivot highs and lows. In this case, however, the pivot highs and lows are confirmed an _unpredictable_ number of bars afterwards, so plots are completely unsuitable for drawing lines between them. Line drawings are suitable because scripts can offset lines an arbitrary and dynamic number of bars into the past. The script below also retroactively _changes_ the color of drawn lines, which are initially white, depending on whether the _next_ line of the same type slopes up or down. Such updates are not possible with plots.

![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-Can-i-plot-diagonals-between-two-points-on-the-chart-2.ZmicdTOe_Z1vv609.webp)
...
Using [na](https://www.tradingview.com/pine-script-reference/v6/#var_na) values for the color or series enables scripts to omit a plot on an _arbitrary_ selection of bars. These two methods have different effects:

- An [na](https://www.tradingview.com/pine-script-reference/v6/#var_na) _color_ value omits the plotted line from the most recent bar with a non-na value to the first bar with an [na](https://www.tradingview.com/pine-script-reference/v6/#var_na) value. The size of the gap is equal to the number of consecutive bars with [na](https://www.tradingview.com/pine-script-reference/v6/#var_na) values.
- An [na](https://www.tradingview.com/pine-script-reference/v6/#var_na) _series_ value omits the plot point for each bar with an [na](https://www.tradingview.com/pine-script-reference/v6/#var_na) value, effectively **increasing the size of the gap by one bar**.
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-How-can-i-plot-a-line-with-gaps-1.D6RMbvkI_25YWKB.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-How-do-i-plot-a-line-using-start-stop-criteria-1.D0se5nwy_Z2vPKB6.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-How-do-i-plot-a-support-or-a-trend-line-1.zCbz0Lc8_ZAn82Y.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-How-do-i-plot-a-support-or-a-trend-line-2.CDeAY9mr_ZHDbMR.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-How-can-i-use-colors-in-my-indicator-plots-1.Cp4v-X8j_1uxHru.webp)

![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-How-can-i-use-colors-in-my-indicator-plots-2.BUNwe5Dz_Z17G4Vs.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-How-can-i-draw-lines-or-labels-into-the-future-1.jzxOMGSo_10l2GW.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-Is-it-possible-to-draw-geometric-shapes-1.ChBhMig6_Z1cPYDn.webp)
...
![image](https://www.tradingview.com/pine-script-docs/_astro/Visuals-Is-it-possible-to-draw-geometric-shapes-2.DEB53-5u_Z1mummy.webp)
