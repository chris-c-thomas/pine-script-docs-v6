...
See also [this FAQ entry](/pine-script-docs/faq/alerts/#how-can-i-get-custom-alerts-on-many-symbols) for an example script that generates alerts on multiple symbols.
